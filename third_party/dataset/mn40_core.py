...
Categories2IDS = {'airplane': 0, 'flower_pot': 1, 'glass_box': 2, 'keyboard': 3, 'monitor': 4, 'night_stand': 5, 'sink': 6, 'table': 7, 'bathtub': 8, 
                  'bed': 9, 'bench': 10, 'bookshelf': 11, 'bottle': 12, 'bowl': 13, 'car': 14, 'chair': 15, 'cone': 16, 'cup': 17, 'curtain': 18, 'desk': 19, 
                  'door': 20, 'dresser': 21, 'guitar': 22, 'lamp': 23, 'laptop': 24, 'mantel': 25, 'person': 26, 'piano': 27, 'plant': 28, 'radio': 29, 
                  'range_hood': 30, 'sofa': 31, 'stairs': 32, 'stool': 33, 'tent': 34, 'toilet': 35, 'tv_stand': 36, 'vase': 37, 
                  'wardrobe': 38, 'xbox': 39}
