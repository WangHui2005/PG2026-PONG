...
Categories2IDS = {'ball': 0, 'balloon': 1, 'book': 2, 'cannon': 3, 'cold_weapon___stick': 4, 'frame': 5, 'gun___pistol': 6, 'headstone': 7, 'plane___delta_wing': 8, 'plant___leaf': 9, 'plant___with_pot': 10, 'table___square': 11, 'watch': 12, 
                  'animal___dinosaur': 13, 'animal___dog': 14, 'animal___duck': 15, 'animal___fish': 16, 'animal___tetrapods': 17, 'bed': 18, 'bird': 19, 'bottle': 20, 'car___common': 21, 'car___truck': 22, 'chair___common': 23, 'chair___sofa_multi-man': 24,
                  'chair___swivel': 25, 'chess': 26, 'chip': 27, 'clock': 28, 'cold_weapon___knife': 29, 'cold_weapon___long': 30, 'cold_weapon___sword': 31, 'computer': 32, 'container': 33, 'cup': 34, 'cycle___bike': 35, 'cycle___moto': 36, 'door': 37, 
                  'gun___musket': 38, 'gun___submachine': 39, 'helmet': 40, 'human_stand': 41, 'hydrant': 42, 'insect___fly': 43, 'insect___polypod': 44, 'lamp___floorlamp': 45, 'lamp___tablelamp': 46, 'missle': 47, 'orchestral': 48, 'pen': 49, 'plane___backswept_wing': 50, 
                  'plane___forwardswept_wing': 51, 'plane___giant': 52, 'plane___helicopter': 53, 'plane___straight_wing': 54, 'plant___flower': 55, 'plant___tree': 56, 'plant___weed': 57, 'ring': 58, 'ship___galleon': 59, 'ship___modern': 60, 'table___round': 61, 'tank': 62, 
                  'tool___hammer': 63, 'tool___screwdriver': 64, 'wheel': 65, 'zeppelin': 66}
