...
from .pc_transforms import PointsToTensor, PointCloudScaling, PointCloudCenterAndNormalize, PointCloudRotation
...
Categories2IDS ={'flat-thin wallcomponents___clips': 0, 'flat-thin wallcomponents___contact switches': 1, 'flat-thin wallcomponents___miscellaneous': 2, 'flat-thin wallcomponents___slender thin plates': 3, 'rectangular-cubic prism___bearing blocks': 4, 'rectangular-cubic prism___contoured surfaces': 5, 'rectangular-cubic prism___l blocks': 6, 'rectangular-cubic prism___machined blocks': 7, 'rectangular-cubic prism___motor bodies': 8, 'rectangular-cubic prism___rocker arms': 9, 'solid of revolution___90 degree elbows': 10, 'solid of revolution___container like parts': 11, 'solid of revolution___intersecting pipes': 12, 'solid of revolution___non-90 degree elbows': 13, 'solid of revolution___oil pans': 14, 'solid of revolution___posts': 15, 'solid of revolution___spoked wheels': 16, 
                 'flat-thin wallcomponents___bracket like parts': 17, 'flat-thin wallcomponents___thin plates': 18, 'rectangular-cubic prism___handles': 19, 'rectangular-cubic prism___long machine elements': 20, 'rectangular-cubic prism___machined plates': 21, 'rectangular-cubic prism___miscellaneous': 22, 'rectangular-cubic prism___prismatic stock': 23, 'rectangular-cubic prism___slender links': 24, 'rectangular-cubic prism___small machined blocks': 25, 'rectangular-cubic prism___t shaped parts': 26, 'rectangular-cubic prism___thick plates': 27, 'rectangular-cubic prism___thick slotted plates': 28, 'rectangular-cubic prism___u shaped parts': 29, 'solid of revolution___bearing like parts': 30, 'solid of revolution___bolt like parts': 31, 'solid of revolution___cylindrical parts': 32, 'solid of revolution___discs': 33, 'solid of revolution___flange like parts': 34, 'solid of revolution___gear like parts': 35, 'solid of revolution___long pins': 36, 'solid of revolution___miscellaneous': 37, 'solid of revolution___nuts': 38, 'solid of revolution___pulley like parts': 39, 'solid of revolution___round change at end': 40}
...
class ESBCoreDataset(Dataset):
    def __init__(self, data_dir, split, modality="mv"):
        ...
        self.label2idx = {label: Categories2IDS[label] for _, label in enumerate(self.label_list)}
        self.idx2label = {Categories2IDS[label]: label for _, label in enumerate(self.label_list)}
